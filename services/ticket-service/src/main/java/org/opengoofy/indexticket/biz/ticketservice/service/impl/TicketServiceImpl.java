...
package org.opengoofy.indexticket.biz.ticketservice.service.impl;
...
import org.opengoofy.indexticket.biz.ticketservice.common.enums.RefundTypeEnum;
import org.opengoofy.indexticket.biz.ticketservice.common.enums.SourceEnum;
import org.opengoofy.indexticket.biz.ticketservice.common.enums.TicketChainMarkEnum;
import org.opengoofy.indexticket.biz.ticketservice.common.enums.TicketStatusEnum;
import org.opengoofy.indexticket.biz.ticketservice.common.enums.VehicleTypeEnum;
import org.opengoofy.indexticket.biz.ticketservice.dao.entity.StationDO;
import org.opengoofy.indexticket.biz.ticketservice.dao.entity.TicketDO;
import org.opengoofy.indexticket.biz.ticketservice.dao.entity.TrainDO;
import org.opengoofy.indexticket.biz.ticketservice.dao.entity.TrainStationPriceDO;
import org.opengoofy.indexticket.biz.ticketservice.dao.entity.TrainStationRelationDO;
import org.opengoofy.indexticket.biz.ticketservice.dao.mapper.StationMapper;
import org.opengoofy.indexticket.biz.ticketservice.dao.mapper.TicketMapper;
import org.opengoofy.indexticket.biz.ticketservice.dao.mapper.TrainMapper;
import org.opengoofy.indexticket.biz.ticketservice.dao.mapper.TrainStationPriceMapper;
import org.opengoofy.indexticket.biz.ticketservice.dao.mapper.TrainStationRelationMapper;
import org.opengoofy.indexticket.biz.ticketservice.dto.domain.PurchaseTicketPassengerDetailDTO;
import org.opengoofy.indexticket.biz.ticketservice.dto.domain.RouteDTO;
import org.opengoofy.indexticket.biz.ticketservice.dto.domain.SeatClassDTO;
import org.opengoofy.indexticket.biz.ticketservice.dto.domain.TicketListDTO;
import org.opengoofy.indexticket.biz.ticketservice.dto.req.CancelTicketOrderReqDTO;
import org.opengoofy.indexticket.biz.ticketservice.dto.req.PurchaseTicketReqDTO;
import org.opengoofy.indexticket.biz.ticketservice.dto.req.RefundTicketReqDTO;
import org.opengoofy.indexticket.biz.ticketservice.dto.req.TicketOrderItemQueryReqDTO;
import org.opengoofy.indexticket.biz.ticketservice.dto.req.TicketPageQueryReqDTO;
import org.opengoofy.indexticket.biz.ticketservice.dto.resp.RefundTicketRespDTO;
import org.opengoofy.indexticket.biz.ticketservice.dto.resp.TicketOrderDetailRespDTO;
import org.opengoofy.indexticket.biz.ticketservice.dto.resp.TicketPageQueryRespDTO;
import org.opengoofy.indexticket.biz.ticketservice.dto.resp.TicketPurchaseRespDTO;
import org.opengoofy.indexticket.biz.ticketservice.remote.PayRemoteService;
import org.opengoofy.indexticket.biz.ticketservice.remote.TicketOrderRemoteService;
import org.opengoofy.indexticket.biz.ticketservice.remote.dto.PayInfoRespDTO;
import org.opengoofy.indexticket.biz.ticketservice.remote.dto.RefundReqDTO;
import org.opengoofy.indexticket.biz.ticketservice.remote.dto.RefundRespDTO;
import org.opengoofy.indexticket.biz.ticketservice.remote.dto.TicketOrderCreateRemoteReqDTO;
import org.opengoofy.indexticket.biz.ticketservice.remote.dto.TicketOrderItemCreateRemoteReqDTO;
import org.opengoofy.indexticket.biz.ticketservice.remote.dto.TicketOrderPassengerDetailRespDTO;
import org.opengoofy.indexticket.biz.ticketservice.service.SeatService;
import org.opengoofy.indexticket.biz.ticketservice.service.TicketService;
import org.opengoofy.indexticket.biz.ticketservice.service.TrainStationService;
import org.opengoofy.indexticket.biz.ticketservice.service.cache.SeatMarginCacheLoader;
import org.opengoofy.indexticket.biz.ticketservice.service.handler.ticket.dto.TrainPurchaseTicketRespDTO;
import org.opengoofy.indexticket.biz.ticketservice.service.handler.ticket.select.TrainSeatTypeSelector;
import org.opengoofy.indexticket.biz.ticketservice.service.handler.ticket.tokenbucket.TicketAvailabilityTokenBucket;
import org.opengoofy.indexticket.biz.ticketservice.toolkit.DateUtil;
import org.opengoofy.indexticket.biz.ticketservice.toolkit.TimeStringComparator;
import org.opengoofy.indexticket.framework.starter.bases.ApplicationContextHolder;
import org.opengoofy.indexticket.framework.starter.cache.DistributedCache;
import org.opengoofy.indexticket.framework.starter.cache.toolkit.CacheUtil;
import org.opengoofy.indexticket.framework.starter.common.toolkit.BeanUtil;
import org.opengoofy.indexticket.framework.starter.convention.exception.ServiceException;
import org.opengoofy.indexticket.framework.starter.convention.result.Result;
import org.opengoofy.indexticket.framework.starter.designpattern.chain.AbstractChainContext;
import org.opengoofy.indexticket.frameworks.starter.user.core.UserContext;
...
import static org.opengoofy.indexticket.biz.ticketservice.common.constant.IndexticketConstant.ADVANCE_TICKET_DAY;
import static org.opengoofy.indexticket.biz.ticketservice.common.constant.RedisKeyConstant.LOCK_PURCHASE_TICKETS;
import static org.opengoofy.indexticket.biz.ticketservice.common.constant.RedisKeyConstant.LOCK_PURCHASE_TICKETS_V2;
import static org.opengoofy.indexticket.biz.ticketservice.common.constant.RedisKeyConstant.LOCK_REGION_TRAIN_STATION;
import static org.opengoofy.indexticket.biz.ticketservice.common.constant.RedisKeyConstant.LOCK_REGION_TRAIN_STATION_MAPPING;
import static org.opengoofy.indexticket.biz.ticketservice.common.constant.RedisKeyConstant.REGION_TRAIN_STATION;
import static org.opengoofy.indexticket.biz.ticketservice.common.constant.RedisKeyConstant.REGION_TRAIN_STATION_MAPPING;
import static org.opengoofy.indexticket.biz.ticketservice.common.constant.RedisKeyConstant.TRAIN_INFO;
import static org.opengoofy.indexticket.biz.ticketservice.common.constant.RedisKeyConstant.TRAIN_STATION_PRICE;
import static org.opengoofy.indexticket.biz.ticketservice.common.constant.RedisKeyConstant.TRAIN_STATION_REMAINING_TICKET;
import static org.opengoofy.indexticket.biz.ticketservice.toolkit.DateUtil.convertDateToLocalTime;
...
public class TicketServiceImpl extends ServiceImpl<TicketMapper, TicketDO> implements TicketService, CommandLineRunner {
    ...
    public TicketPageQueryRespDTO pageListTicketQueryV1(TicketPageQueryReqDTO requestParam) {
        ...
        // 列车查询逻辑较为复杂，详细解析文章查看 https://nageoffer.com/ticket/question
    ...
    public TicketPurchaseRespDTO purchaseTicketsV1(PurchaseTicketReqDTO requestParam) {
        ...
        // 写了详细的 v2 版本购票升级指南，欢迎查阅 https://nageoffer.com/ticket/question
    ...
    public TicketPurchaseRespDTO executePurchaseTickets(PurchaseTicketReqDTO requestParam) {
        ...
        // 节假日高并发购票Redis能扛得住么？详情查看：https://nageoffer.com/ticket/question
        TrainDO trainDO = distributedCache.safeGet(
                TRAIN_INFO + trainId,
                TrainDO.class,
    ...
    public void cancelTicketOrder(CancelTicketOrderReqDTO requestParam) {
        ...
        if (cancelOrderResult.isSuccess() && !StrUtil.equals(ticketAvailabilityCacheUpdateType, "binlog")) {
            Result<org.opengoofy.indexticket.biz.ticketservice.remote.dto.TicketOrderDetailRespDTO> ticketOrderDetailResult = ticketOrderRemoteService.queryTicketOrderByOrderSn(requestParam.getOrderSn());
            org.opengoofy.indexticket.biz.ticketservice.remote.dto.TicketOrderDetailRespDTO ticketOrderDetail = ticketOrderDetailResult.getData();
    ...
    public RefundTicketRespDTO commonTicketRefund(RefundTicketReqDTO requestParam) {
        ...
        Result<org.opengoofy.indexticket.biz.ticketservice.remote.dto.TicketOrderDetailRespDTO> orderDetailRespDTOResult = ticketOrderRemoteService.queryTicketOrderByOrderSn(requestParam.getOrderSn());
        if (!orderDetailRespDTOResult.isSuccess() && Objects.isNull(orderDetailRespDTOResult.getData())) {
            throw new ServiceException("车票订单不存在");
        }
        org.opengoofy.indexticket.biz.ticketservice.remote.dto.TicketOrderDetailRespDTO ticketOrderDetailRespDTO = orderDetailRespDTOResult.getData();
