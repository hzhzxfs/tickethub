...
package org.opengoofy.indexticket.biz.ticketservice.service.handler.ticket.select;
...
import org.opengoofy.indexticket.biz.ticketservice.common.enums.VehicleSeatTypeEnum;
...
import org.opengoofy.indexticket.biz.ticketservice.remote.UserRemoteService;
import org.opengoofy.indexticket.biz.ticketservice.remote.dto.PassengerRespDTO;
import org.opengoofy.indexticket.biz.ticketservice.service.SeatService;
import org.opengoofy.indexticket.biz.ticketservice.service.handler.ticket.dto.SelectSeatDTO;
import org.opengoofy.indexticket.biz.ticketservice.service.handler.ticket.dto.TrainPurchaseTicketRespDTO;
import org.opengoofy.indexticket.framework.starter.convention.exception.RemoteException;
    ...
    public List<TrainPurchaseTicketRespDTO> select(Integer trainType, PurchaseTicketReqDTO requestParam) {
        ...
        if (seatTypeMap.size() > 1) {
            ...
            seatTypeMap.forEach((seatType, passengerSeatDetails) -> {
                // 线程池参数如何设置？详情查看：https://nageoffer.com/ticket/question
            ...
            // 并行流极端情况下有坑，详情参考：https://nageoffer.com/ticket/question
        ...
        // 购买列车中间站点余票如何更新？详细查看：https://nageoffer.com/ticket/question
