...
import org.opengoofy.indexticket.biz.ticketservice.common.enums.SeatStatusEnum;
import org.opengoofy.indexticket.biz.ticketservice.dao.entity.SeatDO;
...
import org.opengoofy.indexticket.biz.ticketservice.mq.event.PayResultCallbackTicketEvent;
...
public class PayResultCallbackTicketConsumer implements RocketMQListener<MessageWrapper<PayResultCallbackTicketEvent>> {
    ...
    @Idempotent(
            uniqueKeyPrefix = "indexticket-ticket:pay_result_callback:",
