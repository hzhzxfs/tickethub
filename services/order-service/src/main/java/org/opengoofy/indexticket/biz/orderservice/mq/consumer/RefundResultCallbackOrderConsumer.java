...
package org.opengoofy.indexticket.biz.orderservice.mq.consumer;

import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import org.apache.rocketmq.spring.annotation.RocketMQMessageListener;
import org.apache.rocketmq.spring.core.RocketMQListener;
import org.opengoofy.indexticket.biz.orderservice.common.constant.OrderRocketMQConstant;
...
import org.opengoofy.indexticket.biz.orderservice.dto.domain.OrderItemStatusReversalDTO;
import org.opengoofy.indexticket.biz.orderservice.dto.resp.TicketOrderPassengerDetailRespDTO;
import org.opengoofy.indexticket.biz.orderservice.mq.domain.MessageWrapper;
import org.opengoofy.indexticket.biz.orderservice.mq.event.RefundResultCallbackOrderEvent;
...
public class RefundResultCallbackOrderConsumer implements RocketMQListener<MessageWrapper<RefundResultCallbackOrderEvent>> {
    ...
    @Idempotent(
            uniqueKeyPrefix = "indexticket-order:refund_result_callback:",
