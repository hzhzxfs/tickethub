...
package org.opengoofy.indexticket.biz.orderservice.service.impl;
...
import org.opengoofy.indexticket.biz.orderservice.common.enums.OrderCanalErrorCodeEnum;
import org.opengoofy.indexticket.biz.orderservice.common.enums.OrderItemStatusEnum;
import org.opengoofy.indexticket.biz.orderservice.common.enums.OrderStatusEnum;
import org.opengoofy.indexticket.biz.orderservice.dao.entity.OrderDO;
import org.opengoofy.indexticket.biz.orderservice.dao.entity.OrderItemDO;
import org.opengoofy.indexticket.biz.orderservice.dao.entity.OrderItemPassengerDO;
import org.opengoofy.indexticket.biz.orderservice.dao.mapper.OrderItemMapper;
import org.opengoofy.indexticket.biz.orderservice.dao.mapper.OrderMapper;
import org.opengoofy.indexticket.biz.orderservice.dto.domain.OrderStatusReversalDTO;
import org.opengoofy.indexticket.biz.orderservice.dto.req.CancelTicketOrderReqDTO;
import org.opengoofy.indexticket.biz.orderservice.dto.req.TicketOrderCreateReqDTO;
import org.opengoofy.indexticket.biz.orderservice.dto.req.TicketOrderItemCreateReqDTO;
import org.opengoofy.indexticket.biz.orderservice.dto.req.TicketOrderPageQueryReqDTO;
import org.opengoofy.indexticket.biz.orderservice.dto.req.TicketOrderSelfPageQueryReqDTO;
import org.opengoofy.indexticket.biz.orderservice.dto.resp.TicketOrderDetailRespDTO;
import org.opengoofy.indexticket.biz.orderservice.dto.resp.TicketOrderDetailSelfRespDTO;
import org.opengoofy.indexticket.biz.orderservice.dto.resp.TicketOrderPassengerDetailRespDTO;
import org.opengoofy.indexticket.biz.orderservice.mq.event.DelayCloseOrderEvent;
import org.opengoofy.indexticket.biz.orderservice.mq.event.PayResultCallbackOrderEvent;
import org.opengoofy.indexticket.biz.orderservice.mq.produce.DelayCloseOrderSendProduce;
import org.opengoofy.indexticket.biz.orderservice.remote.UserRemoteService;
import org.opengoofy.indexticket.biz.orderservice.remote.dto.UserQueryActualRespDTO;
import org.opengoofy.indexticket.biz.orderservice.service.OrderItemService;
import org.opengoofy.indexticket.biz.orderservice.service.OrderPassengerRelationService;
import org.opengoofy.indexticket.biz.orderservice.service.OrderService;
import org.opengoofy.indexticket.biz.orderservice.service.orderid.OrderIdGeneratorManager;
...
import org.opengoofy.indexticket.framework.starter.convention.page.PageResponse;
import org.opengoofy.indexticket.framework.starter.convention.result.Result;
import org.opengoofy.indexticket.framework.starter.database.toolkit.PageUtil;
    ...
    public String createTicketOrder(TicketOrderCreateReqDTO requestParam) {
        ...
        try {
            ...
            DelayCloseOrderEvent delayCloseOrderEvent = DelayCloseOrderEvent.builder()
                    ...
                    .build();
            // 创建订单并支付后延时关闭订单消息怎么办？详情查看：https://nageoffer.com/ticket/question
