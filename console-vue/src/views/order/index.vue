  ...
  <Space :style="{ width: '100%' }" direction="vertical">
    ...
    <div>
      <div class="tips-txt">
        ...
        <p>
          4.一天内3次申请车票成功后取消订单（包含无座票时取消5次计为取消1次），当日将不能在ticket继续购票。
        </p>
        <p>
          <strong
...
.tip-wrapper {
  ...
  .i-lock {
    ...
    width: 42px;
    height: 42px;
    background: url(https://kyfw.ticket.cn/otn/resources/images/bg02.png)
      repeat-x;
...
.cyx-hd {
  ...
  .cyx-hd-label {
    ...
    .icon-cyx {
      ...
      width: 16px;
      height: 16px;
      background-image: url(https://kyfw.ticket.cn/otn/resources/images/icon-cyx.png);
    }
  }
}
::v-deep {
